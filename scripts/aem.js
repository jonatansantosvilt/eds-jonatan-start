...
/**
 * Search for <p> tags with .default-content-wrapper that contain "-section"
 * in the text, and adds the content as a class in the parent with the class .section.
 * @param {Element} main The container element where to perform the search
 */
function decorateSectionClasses(main) {
  main.querySelectorAll(".default-content-wrapper p").forEach((p) => {
    ...
    section.classList.add(toClassName(text));
